...
export const metadata: Metadata = {
  ...
  description: "Закажите инженерный чертеж душевой кабины по вашим размерам. Отправите файл на завод — стекло встанет идеально. Без переплат стекольным компаниям.",
  openGraph: {
    title: "Dwgglass — Онлайн-чертежи стекла для душевых",
